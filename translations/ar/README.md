...
[![مساهمون GitHub](https://img.shields.io/github/contributors/microsoft/ML-For-Beginners.svg)](https://GitHub.com/microsoft/ML-For-Beginners/graphs/contributors/)
...
[![طلبات سحب GitHub](https://img.shields.io/github/issues-pr/microsoft/ML-For-Beginners.svg)](https://GitHub.com/microsoft/ML-For-Beginners/pulls/)
[![PRs مرحب بها](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)

[![مشاهدون GitHub](https://img.shields.io/github/watchers/microsoft/ML-For-Beginners.svg?style=social&label=Watch)](https://GitHub.com/microsoft/ML-For-Beginners/watchers/)
[![فوركات GitHub](https://img.shields.io/github/forks/microsoft/ML-For-Beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/ML-For-Beginners/network/)
...
[![ديسكورد مايكروسوفت فاوندري](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
اتبع هذه الخطوات:
1. **إنشاء فرع خاص بك للمستودع**: اضغط على زر "فرع Fork" في الزاوية العليا اليمنى من هذه الصفحة.
...
[![لافتة ML للمبتدئين](../../translated_images/ar/ml-for-beginners-video-banner.63f694a100034bc6.webp)](https://aka.ms/ml-beginners-videos)

---

## لقاء الفريق

[![فيديو تعريفي](../../images/ml.gif)](https://youtu.be/Tj1XWrDSYJU)
...
> اطلع على [مدونة السلوك](CODE_OF_CONDUCT.md)، [كيفية المساهمة](CONTRIBUTING.md)، [الترجمة](TRANSLATIONS.md)، و[حل المشكلات](TROUBLESHOOTING.md). نرحب بملاحظاتكم البناءة!
...
|    25     |                 ساعد بيتر على تجنب الذئب! 🐺                  | [التعلم المعزز](8-Reinforcement/README.md)            | صالة التعلم المعزز Gym                                                                                                        |                                                [بايثون](8-Reinforcement/2-Gym/README.md)                                                 |                      دميتري                         |
...
### سلسلة المساعد
[![مساعد البرمجة الزوجية للذكاء الاصطناعي](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
[![مساعد لـ C#/.NET](https://img.shields.io/badge/Copilot%20for%20C%23/.NET-FBBF24?style=for-the-badge&labelColor=E5E7EB&color=FBBF24)](https://github.com/microsoft/mastering-github-copilot-for-dotnet-csharp-developers?WT.mc_id=academic-105485-koreyst)
