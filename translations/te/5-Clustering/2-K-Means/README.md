...
![voronoi diagram](../../../../translated_images/te/voronoi.1dc1613fb0439b95.webp)
...
1. ప్రతి కాలమ్ కోసం `boxplot()` పిలిచి బాక్స్‌ప్లాట్ సృష్టించండి:
    ...
    ![outliers](../../../../translated_images/te/boxplots.8228c29dabd0f292.webp)
...
1. 'ఎల్బో పద్ధతి' ఉపయోగించి నిర్ధారించండి.
    ...
    ![elbow method](../../../../translated_images/te/elbow.72676169eed744ff.webp)
...
1. మోడల్ యొక్క ఖచ్చితత్వాన్ని తనిఖీ చేయండి:
    ...
    ![clusters](../../../../translated_images/te/clusters.b635354640d8e4fd.webp)
    ...
    ![problem models](../../../../translated_images/te/problems.f7fb539ccd80608e.webp)
